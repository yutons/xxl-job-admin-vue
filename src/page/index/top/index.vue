<template>
	<div class="avue-top">
		...
		<div class="top-bar__right">
			<el-tooltip v-if="setting.color" effect="dark" :content="$t('navbar.color')" placement="bottom">
				<div class="top-bar__item">
					<top-color></top-color>
				</div>
			</el-tooltip>
			<el-tooltip v-if="setting.debug" effect="dark"
				:content="logsFlag?$t('navbar.bug'):logsLen+$t('navbar.bugs')" placement="bottom">
				<div class="top-bar__item">
					<top-logs></top-logs>
				</div>
			</el-tooltip>
			<el-tooltip v-if="setting.lock" effect="dark" :content="$t('navbar.lock')" placement="bottom">
				<div class="top-bar__item">
					<top-lock></top-lock>
				</div>
			</el-tooltip>
			<el-tooltip v-if="setting.theme" effect="dark" :content="$t('navbar.theme')" placement="bottom">
      ...
      <el-tooltip effect="dark"
        ...
        <div class="top-bar__item top-bar__item--show">
          <top-lang></top-lang>
			...
			<el-tooltip v-if="setting.fullscren" effect="dark"
